					...
					<div class="col-lg-12">
						<section class="panel">
								...
								<c:forEach items="${list}" var="listCoupon">
									<tbody>
										<tr class="active">
											...
											<td><input type="submit" class="modify btn btn-primary" value="수정">
												<input type="submit" class="delete btn btn-danger" value="삭제"></td>
										</tr>
									</tbody>
								</c:forEach>
							</table>
							...
							<div class="modal-layout">
								<h4>쿠폰 코드 : <input type="text"></h4>
								
								<h4>쿠폰 이름 : <input type="text"></h4>
								
								<h4>쿠폰 내용 : <input type="text"></h4>
...
<!-- 								<h4>
								...
								<input type="button" class="close" value="등록" />
							</div>
						</section>
